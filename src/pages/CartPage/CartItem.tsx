        ...
        <S.CartItem key={idx}>
          ...
          <S.CartItemBodyContainer>
            <S.CartItemBody>
              ...
              <S.ItemInfoWrapper>
                ...
                <S.PriceAndCount>
                  <S.ItemSaleContainer>
                    <S.ItemOriginalPrice>{item.price1.toLocaleString()}원</S.ItemOriginalPrice>
                    <S.ItemSalePrice>{item.price2.toLocaleString()}원</S.ItemSalePrice>
                  </S.ItemSaleContainer>
                  <S.CounterContainer>
                    {onQuantityChange ? (
                      <Counter
          ...
          <S.ItemTotalPrice>
            ...
            <S.ItemTotalPriceValue>
              {(item.price2 * item.quantity).toLocaleString()}원
            </S.ItemTotalPriceValue>
          </S.ItemTotalPrice>
        </S.CartItem>
      ))}
